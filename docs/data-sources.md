...
**RentCast** — [docs](https://developers.rentcast.io/reference/introduction) · [pricing](https://www.rentcast.io/api). Owner names and mailing address, sale history, taxes by address; **50 free requests a month**, then $74/mo. **Verdict:** a zero-cost start for named owners by address; APN lookup unconfirmed.
