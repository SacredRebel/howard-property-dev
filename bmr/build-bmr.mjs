...
import { BMR_VISION_ZONES, BMR_VISION_PANEL, BMR_VISION_LABEL_CHIP, BMR_TODAY_ZONES, BMR_STATUS, BMR_DOCS } from './vision.mjs';
...
export const BMR_PROPERTY = {
  ...
  status: ${JSON.stringify(BMR_STATUS)},
  docs: ${JSON.stringify(BMR_DOCS)},
