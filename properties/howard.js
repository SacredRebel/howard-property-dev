...
const VISION_PANEL_HTML = 
      ...
      '<div class="property-info-section">' +
        ...
        '<div style="background: linear-gradient(135deg, #f3eefc 0%, #fff8e6 100%); padding: 16px; border-radius: 10px; border-left: 4px solid #6a3d9a;">' +
          '<p style="margin: 0 0 10px 0; line-height: 1.7; color: #444;">Howard, this map is my proposal to you. You have 44 raw acres and a wish to see agriculture happen here. I am a visionary, a designer and a creator — and I am looking for my next home base. I would like it to be your land.</p>' +
          '<p style="margin: 0 0 10px 0; line-height: 1.7; color: #444;"><strong>What I bring:</strong> the vision and master design, the teams and workflows to realize it — hugelkultur, nursery, mushrooms, bees, livestock, compost as one living system — plus the digital craft to map, document and manage everything (this living map is the first artifact).</p>' +
          '<p style="margin: 0 0 10px 0; line-height: 1.7; color: #444;"><strong>What I ask:</strong> a place to live on the land while I lead its development — starting simply (studio / cabin), growing only with your blessing. Every project on this map is placed as a suggestion; tap any icon to explore it. We build only what we agree on, phase by phase.</p>' +
        '</div>' +
      '</div>' +
      '<div class="property-info-section">' +
...
export const HOWARD_PROPERTY = {
  ...
  status: {"today": {"badge": "\ud83e\udd1d Private Land \u2014 Proposal Invited", "rows": [["Owner", "Howard (private)"], ["Status", "Not for sale \u2014 raw land + residence"], ["Openness", "Owner invites agriculture project ideas"], ["Acreage", "~44.1 ac \u00b7 OS-40 zoning"]], "note": "Howard has welcomed ideas for agricultural projects on this land. What you see in Today mode is the property exactly as it stands."}, "vision": {"badge": "\ud83c\udf31 Live Proposal \u2014 for Howard", "rows": [["Proposal", "Regenerative agriculture homestead & community workshop"], ["Model", "Resident vision-lead \u2014 design, teams & phased projects"], ["Partner", "Paul \u2014 visionary, designer & software creator"], ["Ask", "A home base on the land in exchange for full development"]], "note": "Everything in Vision mode is a proposal for Howard to consider \u2014 13 projects, each flexible, each a conversation. Two documents below \u2014 who Paul is, and the land's full potential."}},
  docs: [{"label": "Paul Muresan \u2014 Land, Code & Craft (PDF)", "file": "docs/howard/Paul-Muresan-Brochure.pdf"}, {"label": "The Howard Property \u2014 Land & Potential (PDF)", "file": "docs/howard/Howard-Property-Land-Potential.pdf"}],
